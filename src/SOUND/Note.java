...
public class Note implements Cloneable{
    ...
    public Note(double s, double t, double d, double b, double freq, int gen, int amp, int env, boolean isAkkord) {
		this.start = s;
    ...
    public static Note getFromString(String s) {
    	...
    	Note ret = new Note(st, te, da, ba, fr, gen, amp, env, isAk);
