...
public CEditor(String home, String user, String opt) {
    ...
    JBorderPanel top = new JBorderPanel();
...
public void setMenubar() {
    ...
    */
    ...
    m2.addSeparator();
    //---------------
    mi1_5 = new JMenuItem(this.text[70]); // Play
    mi1_5.setFont(this.font);
    mi1_5.addActionListener(this);
    //m2.add(mi1_5);
    //m2.addSeparator();
    //--
    mi2_1 = new JMenuItem(this.text[32]); // About
 ...
 * Oszi panel 
 */
private JBorderPanel getBody() {
    int row = 0;
    JBorderPanel pb = new JBorderPanel();
    pb.setTextFont(this.font); 
    this.pr = new JBorderPanel();	//Random related
    this.pt = new JBorderPanel();	//Tone related
...
// --------- min_freq Textfield ------------
    ...
    c.gridy= row;
    c.insets = left;
    JPanel minFreq = getTextPanel(0, this.text[19], this.text[25]); // Hz
    gridbag.setConstraints(minFreq,c);
    pt.add(minFreq);
// --------- max_freq Textfield ------------
    c.gridx= 1;
    c.gridy= row;
    JPanel maxFreq = getTextPanel(1, this.text[18], this.text[25]); // Hz
    gridbag.setConstraints(maxFreq,c);
    pt.add(maxFreq);
    // --------- Seed Textfield ------------
    c.gridx= 2;
    c.gridy= row;
    JPanel seedP = getTextPanel(2, this.text[46], this.text[25]); // Hz
    ...
    c.gridx= 0;
    c.gridy= row;
    JPanel minDurP = getTextPanel(3, this.text[24], this.text[26]); // sec
    gridbag.setConstraints(minDurP,c);
    pt.add(minDurP);
// --------- Max Duration Textfield ------------
    c.gridx= 1;
    c.gridy= row;
    JPanel maxDurP = getTextPanel(4, this.text[42], this.text[26]); // sec
    ...
    JPanel durP = getChoicePanel(5, this.text[71], elements);
    ...
    c.gridy= row;
    c.insets = left;
    cb2 = new JCheckBox(this.text[65]);
    ...
    c.gridy= row;
    elements = setLChoice();
    JPanel minLoudP = getChoicePanel(6, this.text[44], elements);
    ...
    c.gridy= row;
    elements = setHChoice();
    JPanel maxLoudP = getChoicePanel(7, this.text[45], elements);
    ...
    cb1 = new JCheckBox(this.text[43]);
    ...
    c.gridy= row;
    elements = setLVoice();
    JPanel minVoiP = getChoicePanel(8, this.text[52], elements);
    ...
    c.gridy= row;
    elements = setLVoice();
    JPanel maxVoiP = getChoicePanel(9, this.text[53], elements);
    ...
    JPanel gamP = getChoicePanel(10, this.text[54], elements);
...
// --------- Population Textfield ------------
    ...
    c.gridx= 0;
    c.gridy= row;
    JPanel popP = getTextPanel(11, this.text[20], null);
...
// --------- Number of fittest Textfield ------------
    c.gridx= 1;
    c.gridy= row;
    JPanel nofP = getTextPanel(12, this.text[21], null);
    gridbag.setConstraints(nofP,c);
    pr.add(nofP);
    // --------- Interval Textfield ------------
    c.gridx= 2;
    c.gridy= row;
    JPanel interP = getTextPanel(13, this.text[23], this.text[25]);
    gridbag.setConstraints(interP,c);
    pr.add(interP);
    // --------- Diff. Freq. Textfield ------------
    c.gridx= 3;
    c.gridy= row;
    JPanel diffFP = getTextPanel(14, this.text[29], this.text[25]);
    ...
    c.gridx= 0;
    c.gridy= row;
    JPanel randWP = getTextPanel(15, this.text[27], null);
    gridbag.setConstraints(randWP,c);
    pr.add(randWP);
    // --------- Degression Textfield ------------
    c.gridx= 1;
    c.gridy= row;
    JPanel degP = getTextPanel(16, this.text[72], null);
    ...
    c.gridx= 2;
    c.gridy= row;
    JPanel iterP = getTextPanel(17, this.text[28], null);
...
public void setToWait(Component Co, boolean w) {
    ...
    start.setEnabled(w);
    this.pt.setEnableState(w);
    this.pr.setEnableState(w);
    this.body.setEnableState(w);
}
